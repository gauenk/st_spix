...
__host__ void CudaCalcMergeCandidate(const float* image_gpu_double, int* split_merge_pairs, int* seg, bool* border,  superpixel_params* sp_params, superpixel_GPU_helper* sp_gpu_helper, superpixel_GPU_helper_sm* sp_gpu_helper_sm, const int nPixels, const int nbatch, const int xdim, const int ydim, const int nftrs, const int nSPs_buffer, const int change, float i_std, float alpha);
...
__global__ void sum_by_label_sm(const float* image_gpu_double, const int* seg_gpu, superpixel_params* sp_params, superpixel_GPU_helper_sm* sp_gpu_helper_sm, const int nPixels, const int nbatch, const int xdim, const int nftrs);
...
/* __global__ void fill_zeros_at_border(int* dist, bool* border, int* spix, */
