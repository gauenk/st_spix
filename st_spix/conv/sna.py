...
class SuperpixelConvolution(nn.Module):
    ...
    defs = {"attn_type":"soft","dist_type":"prod","normz_patch":False,
            "qk_scale":1.,"nheads":1,"kernel_size":5,"dilation":1,
            ...
            "learn_attn_scale":False,"sp_nftrs":None,
            "proj_attn_layer":False,"proj_attn_bias":False,"run_attn_search":True}
